...
void TimeHandler::onRequest(std::unique_ptr<proxygen::HTTPMessage> headers) noexcept
{
...
void TimeHandler::requestComplete() noexcept
{
    delete this;
}

void TimeHandler::onError(proxygen::ProxygenError err) noexcept
{
